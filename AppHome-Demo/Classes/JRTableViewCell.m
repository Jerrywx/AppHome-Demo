...
@interface JRTableViewCell () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame {
	...
	if (self =[super initWithFrame:frame]) {
		...
		[self.collectionView registerClass:[MusicManCell class] forCellWithReuseIdentifier:@"item"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	MusicManCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"item" forIndexPath:indexPath];
